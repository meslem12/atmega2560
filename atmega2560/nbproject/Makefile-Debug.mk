...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/atmega2560.exe
...
${OBJECTDIR}/jsmn.o: jsmn.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__AVR_ATmega2560__ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/jsmn.o jsmn.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__AVR_ATmega2560__ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
